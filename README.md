...
## # Criando clone da página inicial do iFood

<!-- TOC -->

- [BOOTCAMP MRV FULLSTACK DEVELOPER - DIGITAL INNOVATION ONE](#bootcamp-mrv-fullstack-developer---digital-innovation-one)
    - [# Criando clone da página inicial do iFood](#-criando-clone-da-p%C3%A1gina-inicial-do-ifood)
...
Reproduzir a tela inicial do iFood usando o Reactive Native.
